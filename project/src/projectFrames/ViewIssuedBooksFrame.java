...
public class ViewIssuedBooksFrame extends javax.swing.JFrame {
    ...
    public ViewIssuedBooksFrame(String Name) {
        initComponents();
        setVisible(true);
        setAlwaysOnTop(true);
        Toolkit t = Toolkit.getDefaultToolkit();
    ...
    public void setIssueBookDetailsToTable() {
        try {
            ...
            String sql = "SELECT * FROM issue_book_table WHERE status = 'Pending'";
            ...
            while (rs.next()) {
                ...
                Object[] obj = {issueID, bookTitle, name, studentNo, issueDate, dueDate, remarks};
                model.addRow(obj);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void filterIssueBookTable() {
        try {
            ...
            //having a hard time here, stringbuilder append, TODO search by name,stud no //finished //same logic from view records
            StringBuilder sql = new StringBuilder("SELECT issueID, bookTitle, name, studentNo, issueDate, dueDate, remarks FROM issue_book_table WHERE status = 'Pending'");
    ...
    private void initComponents() {
        ...
        viewIssuedBooksTab.setBackground(new java.awt.Color(51, 102, 0));
        ...
        comLogHeader.setText("   Issued  Books Records");
        ...
        issueBookTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Issue No.", "Book Title", "Name", "Student No.", "Issue Date", "Due Date", "Remarks"
            }
        ) {
        ...
        homePanel.add(filterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 130, 140, 40));
