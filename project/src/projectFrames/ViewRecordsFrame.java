 ...
 * @author Chessman
 */
public class ViewRecordsFrame extends javax.swing.JFrame {
    ...
    public ViewRecordsFrame(String Name) {
        initComponents();
        setVisible(true);
        setAlwaysOnTop(true);
        Toolkit t = Toolkit.getDefaultToolkit();
    ...
    public void setIssueBookDetailsToTable() {
        try {
            ...
            String sql = "SELECT * FROM issue_book_table";
            ...
            while (rs.next()) {
                ...
                Object[] obj = {issueID, bookID, name, studentNo, contact, issueDate, dueDate, remarks, status};
    ...
    //to filter the data
    private void filterIssueBookTable() {
        try {
            ...
            String statusFilter = filterByComboBox.getSelectedItem().toString();

            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            String fromDateStr = (fromDate != null) ? sdf.format(fromDate) : null;
            String toDateStr = (toDate != null) ? sdf.format(toDate) : null;
            
            //having a hard time here, stringbuilder append, TODO search by stud no //finished
            StringBuilder sql = new StringBuilder("SELECT * FROM issue_book_table WHERE 1=1");
            ...
            //reduced to two since the parameters are name and stud no.
            int paramIndex = 1;
            if (!searchText.isEmpty()) {
    ...
    private void initComponents() {
        ...
        viewRecordsTab.setBackground(new java.awt.Color(51, 102, 0));
        ...
        comLogHeader.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AllRecordsIcons/book-user.png"))); // NOI18N
        comLogHeader.setText("   All  Records");
        homePanel.add(comLogHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 520, -1));
        ...
        homePanel.add(comLogHeaderLine, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 520, 5));
        ...
        issueBookTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Issue No.", "Book ID", "Name", "Student No.", "Contact", "Issue Date", "Due Date", "Remarks", "Status"
            }
        ) {
        ...
        homePanel.add(manageTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 1180, 570));
        ...
        searchTxtField.setPlaceholder("Search by Student No.");
        ...
        homePanel.add(filterFrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 130, 140, -1));
        ...
        homePanel.add(filterFromLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 100, -1));
        ...
        homePanel.add(filterToLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, 100, -1));
        homePanel.add(filterTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 180, 140, -1));
        ...
        homePanel.add(filterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 140, 140, 40));
        ...
        filterByComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Pending", "Returned" }));
        homePanel.add(filterByComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 150, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRecordsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
